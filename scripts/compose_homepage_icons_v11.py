...
ICON_SOURCES = (
    (
        "tramy",
        Path("tmp/artwork-v11/beam/beam-3-4-master-v11.webp"),
        Path("tmp/artwork-v11/beam/beam-3-4-master-v11.manifest.json"),
        "tramy-icon-master-v11.webp",
        "2+1",
    ),
    (
        "fosny",
        Path("tmp/composed_planks/plank/plank-5-8-master-v11.webp"),
        Path("tmp/composed_planks/plank/plank-5-8-master-v11.manifest.json"),
        "fosny-icon-master-v11.webp",
        "3x2",
    ),
    (
        "prkna",
        Path("tmp/composed_boards/board/board-5-8-master-v11.webp"),
        Path("tmp/composed_boards/board/board-5-8-master-v11.manifest.json"),
        "prkna-icon-master-v11.webp",
        "3x2",
    ),
    (
        "late",
